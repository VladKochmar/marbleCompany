(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-swiper-page__slider")) {
                let mainSwiperPage = new core(".main-swiper-page__slider", {
            ...
            if (document.querySelector(".bottom-products__slider")) new core(".bottom-products__slider", {
            ...
            if (document.querySelector(".swiper-article__slider")) new core(".swiper-article__slider", {
                modules: [ Navigation, Lazy ],
                observer: true,
                observeParents: true,
                autoHeight: false,
            ...
            if (document.querySelector(".photo-swiper__slider")) new core(".photo-swiper__slider", {
...
***************************************************************************** */
        ...
        for (let select of countrySelects) if (select.dataset.country != countriesSelectOriginal.value) select.parentElement.style.display = "none";
        document.addEventListener("click", (e => {
            for (let item of countriesList) if (e.target == item) for (let select of countrySelects) if (select.dataset.country != countriesSelectOriginal.value) select.parentElement.style.display = "none"; else {
                select.parentElement.style.display = "block";
                for (let city of citiesList) if (select.value == city.dataset.value) for (let number of phones) if (number.id == city.dataset.value) number.style.display = "flex"; else number.style.display = "none";
            }
            for (let city of citiesList) if (e.target == city) for (let number of phones) if (number.id == city.dataset.value) number.style.display = "flex"; else number.style.display = "none";
